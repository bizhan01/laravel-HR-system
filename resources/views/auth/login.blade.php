			...
			<div class="sign-form">
				<div class="row">
					<div class="col-md-5 offset-md-3 px-3">
						<div class="box b-a-0">
							<div class="p-2 text-xs-center">
								<img src="\img\logo\logo.png" height="100px" alt="" /><br></br>
								<h5 style="color: #f4a030">خوش آمدید</h5>
								<h6 style="color: #26abd7 ">سیستم گزارش دهی دپارتمنت آی تی وزارت صنعت و تجارت</h6>
							</div>
                  ...
                  @endif
								...
								<div class="form-group">
									<input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required id="exampleInputPassword" placeholder="*************">
